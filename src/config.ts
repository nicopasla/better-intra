...
export interface BetterIntraConfig {
  ...
  LOGTIME_SHOW_TOTAL_TACOS: boolean;
  LOGTIME_SHOW_STREAK: boolean;
...
export const CONFIG_DEFAULT: BetterIntraConfig = {
  ...
  PROFILE_V2_BLACKHOLE: false,
  PROFILE_BLACKHOLE_SHOW_COUNTDOWN: true,
